        ...
        <ParticlesComponent></ParticlesComponent>
            <div className="flex flex-col items-center justify-center min-w-full">
                <div className="flex flex-col items-center ">
                    <h1 className="text-gray-300 text-3xl md:text-5xl font-bold mt-20 md:mt-32">
                        Hi, I'm Khaled Tujjar
                    </h1>
                    <h1 className="text-blue-400 text-3xl md:text-5xl font-bold mt-2">
                ...
                <img
                    ...
                    alt="Profile"
                    className="w-64 h-64 md:w-72 md:h-72 rounded-full mt-8"
                />  
                <ul className="flex mt-4">
                    <a href="https://github.com/KTujjar" aria-label="Github" target="_blank" rel="noopener noreferrer">
                        ...
                        alt="Github"
                        className="h-16 w-16 mx-2 cursor-pointer mt-4 hover:scale-125 flex flex-col justify-center items-center"
                        />
                    </a>
