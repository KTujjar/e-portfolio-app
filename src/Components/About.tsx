  ...
  return (
    <div id='about' className="min-h-screen bg-gray-50 space-y-4 p-4 drop-shadow-sm">
      <div className="max-w-7xl x-4 px-8 mx-auto items-center">
        <h1 className="text-black text-5xl my-12 font-bold text-center">
            About Me
        </h1>
        <div className="flex flex-col w">
          ...
          <h1 className="text-left text-4xl font-bold text-blue-400 my-4"> Technologies and Tools</h1>
          <p className="text-left text-2xl font-semibold text-gray-500"> 
        ...
        <div className="flex flex-wrap mt-8">
          <div data-title="C" className="box py-2 px-2 w-32 mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-blue-300 bg-gray-100 rounded-lg">
          ...
          <div data-title="TypeScript" className="box py-2 px-2 w-32  mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-blue-300 bg-gray-100 rounded-lg">
          ...
          <div data-title="JavaScript" className="box py-2 px-2 w-32  mx-4 my-4 hover:scale-125 bg-gray-100 hover:shadow-lg hover:shadow-yellow-200 rounded-lg">
          ...
          <div data-title="Python" className="box py-2 px-2 w-32 mx-4 my-4 hover:scale-125 bg-gray-100 hover:shadow-lg hover-shadow-python rounded-lg">
          ...
          <div data-title="Java" className="box py-2 px-2 w-32  mx-4 my-4 hover:scale-125 hover:shadow-lg hover-shadow-java bg-gray-100 rounded-lg">
          ...
          <div data-title="HTML" className="box py-2 px-2 w-32  mx-4 my-4 hover:scale-125  hover:shadow-lg hover:shadow-orange-300 bg-gray-100 rounded-lg">
          ...
          <div data-title="CSS" className="box py-2 px-2 w-32 mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-blue-200 bg-gray-100 rounded-lg">
          ...
          <div data-title="NodeJS" className="box py-2 px-2 w-32  mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-green-300 bg-gray-100 rounded-lg">
          ...
          <div data-title="React" className="box py-2 px-2 w-32  mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-blue-200 bg-gray-100 rounded-lg">
          ...
          <div data-title="Tailwind" className="box py-2 px-2 w-32 mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-blue-200 bg-gray-100 rounded-lg">
          ...
          <div data-title="Git" className="box py-2 px-2 w-32 mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-orange-300 bg-gray-100 rounded-lg">
          ...
          <div data-title="Angular" className="box py-2 px-2 w-32 mx-4 my-4 hover:scale-125 hover:shadow-lg hover:shadow-red-400 bg-gray-100 rounded-lg">
