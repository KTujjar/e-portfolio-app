...
const Projects: React.FC = () => {
  return (
    <div id="projects" className="min-h-screen  bg-gray-200 flex flex-col space-y-4 p-4 items-center font-bold drop-shadow-sm">
        <h1 className="text-black  text-4xl sm:text-5xl my-12">
            Projects
        </h1>
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-16 p-4">
            <div className="box sm:h-[40vh] sm:w-[50vh] h-[30vh] w-[40vh] md:h-[55vh] md:w-[65vh] hover:shadow-xl hover:shadow-indigo-400  group relative bg-[url('./assets/rocketdocs.png')] max-h-[65vh] max-w-[65vh] bg-[length:500px_380px] md:bg-cover text-white rounded-lg border-gray-400 border-2 hover:scale-110 transition-all ease-in-out delay-50 duration-300">
            ...
            <div className="box sm:h-[40vh] sm:w-[50vh] h-[30vh] w-[40vh] md:h-[55vh] md:w-[65vh] group relative bg-[url('./assets/pwdly.png')] hover:shadow-xl hover:shadow-blue-400 max-h-[65vh] max-w-[65vh] bg-[length:500px_380px] md:bg-cover text-white rounded-lg border-gray-400 border-2 hover:scale-110 transition-all ease-in-out delay-50 duration-300">
              <div className="bg-gray-600 opacity-0 flex flex-row justify-between md:justify-normal md:flex-col relative group-hover:opacity-95 px-4 py-4 h-1/3 rounded-b-lg top-2/3 transition-all ease-in-out delay-100 duration-300">
            ...
            <div className="box  sm:h-[40vh] sm:w-[50vh] h-[30vh] w-[40vh] md:h-[55vh] md:w-[65vh] group relative bg-[url('./assets/SnakeGame.gif')] hover:shadow-xl hover:shadow-green-500 max-h-[65vh] max-w-[65vh] bg-center bg-[length:370px_280px] md:bg-[length:600px_520px] bg-no-repeat bg-size-100% text-white rounded-lg border-gray-400 border-2 hover:scale-110 transition-all ease-in-out delay-50 duration-300">
              <div className="bg-gray-600 opacity-0 flex flex-row justify-between md:justify-normal md:flex-col relative group-hover:opacity-95 px-4 py-4 h-1/3 rounded-b-lg top-2/3 transition-all ease-in-out delay-100 duration-300">
